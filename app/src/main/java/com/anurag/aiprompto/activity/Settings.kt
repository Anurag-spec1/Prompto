...
import com.anurag.aiprompto.databinding.ActivitySettingsBinding
...
class Settings : AppCompatActivity() {
    ...
    private fun setupUI() {
        ...
        binding.whatsappLayout.setOnClickListener {
            val intent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://wa.me/+918757772761")
            )
            startActivity(intent)
        }
        binding.customerSupportLayout.setOnClickListener {
            val intent = Intent(Intent.ACTION_SENDTO).apply {
                ...
                putExtra(Intent.EXTRA_EMAIL, arrayOf("anurag.2428cse2059@kiet.edu"))
        ...
        binding.appNotWorkingLayout.setOnClickListener {
            val intent = Intent(Intent.ACTION_SENDTO).apply {
                data = Uri.parse("mailto:")
                putExtra(Intent.EXTRA_EMAIL, arrayOf("anshul.2428cse2256@kiet.edu"))
