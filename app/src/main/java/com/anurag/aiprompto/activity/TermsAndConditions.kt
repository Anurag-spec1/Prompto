...
import com.anurag.aiprompto.databinding.ActivityTermsAndConditionsBinding
...
class TermsAndConditions : AppCompatActivity() {
    ...
    private fun getTermsAndConditions() {
        ApiClient.getInstance().getApiService().getConditions()
            .enqueue(object : Callback<ConditionsResponse> {
